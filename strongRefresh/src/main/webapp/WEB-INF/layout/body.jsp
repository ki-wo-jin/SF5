...
<div class="site-section block-3 site-blocks-2 bg-light">
	<div class="container">
		...
		<div class="row" id = "rlist" style = 'display: none'>
			<div class="col-md-12">
				<div class="nonloop-block-3 owl-carousel">
					<div class="item">
						<div class="block-4 text-center">
							<figure class="block-4-image">
								<img id = "prdImg" src="images/cloth_1.jpg" alt="Image placeholder"
									class="img-fluid">
							</figure>
							<div class="block-4-text p-4">
								<h3>
									<a id = "ahref">Tank Top</a>
								</h3>
								<p class="mb-0">Finding perfect products</p>
								<p class="text-primary font-weight-bold" id = "price">$50</p>
							</div>
						</div>
					</div>
				</div>
...
<script defer src="jsf5/kwj/body.js"></script>