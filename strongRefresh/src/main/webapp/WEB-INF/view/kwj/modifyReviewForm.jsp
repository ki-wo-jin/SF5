...
<div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Review</strong></div>
        </div>
      </div>
    </div>  
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  ...
                  <input type="text" style="display:none;" id="no" name="no">
                   ...
                   <div class="col-md-12">
                 <div class="form-group row">
                    <label for="c_subject" class="text-black">상품 번호 </label>
                    <input type="text" class="form-control" id="code" name="code" readonly>
                  </div>
                	</div>
                   <div class="col-md-12">
                 <div class="form-group row">
                    <label for="c_subject" class="text-black">주문 번호 </label>
                    <input type="text" class="form-control" id="order" name="order" readonly>
                  </div>
                	</div>
                 <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_subject" class="text-black">별점 </label>
                  </div>
                  <div class="col-md-12">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">이미지</label>
 ...
 <script defer src="jsf5/kwj/modifyReview.js"></script>