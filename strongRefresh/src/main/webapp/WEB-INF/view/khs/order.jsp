            ...
            <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="recipient" name="recipient" value="" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-2" id="addressDetail" name="addressDetail" placeholder="상세주소">
                        <input type="text" class="form-control mt-2" id="reference" name="reference" placeholder="참고항목">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="domain-txt" name="domain-txt" value="">
                            </div>
                            <div class="col-md-3">
